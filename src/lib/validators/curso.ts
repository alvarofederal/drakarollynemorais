...
export const cursoSchema = z
  .object({
    ...
    capaUrl: z.string().url().optional().nullable().or(z.literal("")),
    ...
    tipoAcesso: z.enum(TIPOS_ACESSO).default("PRAZO_DIAS"),
    acessoDias: z.coerce.number().int().min(1).max(3650).optional().nullable().default(365),
...
export const aulaSchema = z.object({
  ...
  /// Texto do balão que aparece ao passar o mouse no card
